...
use spam_align::data_loaders::{balibase, format_as_fasta, Alignment};
use spam_align::spaced_word::read_patterns_from_file;
use spam_align::Sequences;
use std::error::Error;

fn main() -> Result<(), Box<dyn Error>> {
    let alignment = balibase::parse_xml_file("data/bb3_release/RV30/BBS30010.xml").unwrap();
